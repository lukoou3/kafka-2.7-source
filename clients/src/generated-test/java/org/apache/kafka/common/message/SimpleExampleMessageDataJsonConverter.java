...
public class SimpleExampleMessageDataJsonConverter {
    public static SimpleExampleMessageData read(JsonNode _node, short _version) {
        ...
        if (_processIdNode == null) {
            if (_version >= 1) {
                ...
                _object.processId = MessageUtil.ZERO_UUID;
            }
        } else {
        ...
        if (_taggedUuidNode == null) {
            _object.taggedUuid = UUID.fromString("212d5494-4a8b-4fdf-94b3-88b470beb367");
        } else {
    ...
    public static JsonNode write(SimpleExampleMessageData _object, short _version) {
        ...
        if (_version >= 1) {
            ...
            if (!_object.processId.equals(MessageUtil.ZERO_UUID)) {
        ...
        if (_version >= 1) {
            if (!_object.taggedUuid.equals(UUID.fromString("212d5494-4a8b-4fdf-94b3-88b470beb367"))) {
        ...
        if (_version >= 2) {
            _node.set("myStruct", MyStructJsonConverter.write(_object.myStruct, _version));
        } else {
        ...
        if (_version >= 2) {
            if (!_object.myTaggedStruct.equals(new TaggedStruct())) {
                _node.set("myTaggedStruct", TaggedStructJsonConverter.write(_object.myTaggedStruct, _version));
            }
        } else {
            if (!_object.myTaggedStruct.equals(new TaggedStruct())) {
        ...
        _node.set("myCommonStruct", TestCommonStructJsonConverter.write(_object.myCommonStruct, _version));
        _node.set("myOtherCommonStruct", TestCommonStructJsonConverter.write(_object.myOtherCommonStruct, _version));
        return _node;
    }
    ...
    public static class MyStructJsonConverter {
        ...
        public static JsonNode write(MyStruct _object, short _version) {
            ...
            for (StructArray _element : _object.arrayInStruct) {
                _arrayInStructArray.add(StructArrayJsonConverter.write(_element, _version));
            }
