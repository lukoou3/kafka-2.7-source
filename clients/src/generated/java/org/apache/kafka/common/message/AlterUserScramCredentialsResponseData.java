...
public class AlterUserScramCredentialsResponseData implements ApiMessage {
    ...
    public AlterUserScramCredentialsResponseData(Struct _struct, short _version) {
    ...
    public void read(Readable _readable, short _version) {
        this.throttleTimeMs = _readable.readInt();
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<AlterUserScramCredentialsResult> newCollection = new ArrayList<AlterUserScramCredentialsResult>(arrayLength);
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        this.throttleTimeMs = struct.getInt("throttle_time_ms");
        {
            ...
            this.results = new ArrayList<AlterUserScramCredentialsResult>(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.results.add(new AlterUserScramCredentialsResult((Struct) nestedObject, _version));
            }
        }
    ...
    public Struct toStruct(short _version) {
        ...
        struct.set("throttle_time_ms", this.throttleTimeMs);
        {
            ...
            int i = 0;
            for (AlterUserScramCredentialsResult element : this.results) {
    ...
    public static class AlterUserScramCredentialsResult implements Message {
        ...
        public AlterUserScramCredentialsResult(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public Struct toStruct(short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of AlterUserScramCredentialsResult");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            _taggedFields = new TreeMap<>();
            Struct struct = new Struct(SCHEMAS[_version]);
