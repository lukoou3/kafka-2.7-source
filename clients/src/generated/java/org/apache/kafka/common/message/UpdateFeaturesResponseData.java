...
public class UpdateFeaturesResponseData implements ApiMessage {
    ...
    public UpdateFeaturesResponseData(Struct _struct, short _version) {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        this.errorMessage = struct.getString("error_message");
        {
            ...
            this.results = new UpdatableFeatureResultCollection(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.results.add(new UpdatableFeatureResult((Struct) nestedObject, _version));
            }
        }
    ...
    public Struct toStruct(short _version) {
        ...
        struct.set("error_message", this.errorMessage);
        {
            ...
            int i = 0;
            for (UpdatableFeatureResult element : this.results) {
    ...
    public static class UpdatableFeatureResult implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public UpdatableFeatureResult(Struct _struct, short _version) {
            fromStruct(_struct, _version);
            this.prev = ImplicitLinkedHashCollection.INVALID_INDEX;
            this.next = ImplicitLinkedHashCollection.INVALID_INDEX;
        }
