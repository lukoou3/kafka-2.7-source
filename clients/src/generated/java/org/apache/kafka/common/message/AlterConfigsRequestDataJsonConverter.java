...
import static org.apache.kafka.common.message.AlterConfigsRequestData.*;
...
public class AlterConfigsRequestDataJsonConverter {
    public static AlterConfigsRequestData read(JsonNode _node, short _version) {
        ...
        if (_resourcesNode == null) {
            ...
            AlterConfigsResourceCollection _collection = new AlterConfigsResourceCollection();
    ...
    public static JsonNode write(AlterConfigsRequestData _object, short _version) {
        ...
        for (AlterConfigsResource _element : _object.resources) {
            _resourcesArray.add(AlterConfigsResourceJsonConverter.write(_element, _version));
        }
    ...
    public static class AlterConfigsResourceJsonConverter {
        public static AlterConfigsResource read(JsonNode _node, short _version) {
            ...
            if (_configsNode == null) {
                ...
                AlterableConfigCollection _collection = new AlterableConfigCollection();
        ...
        public static JsonNode write(AlterConfigsResource _object, short _version) {
            ...
            for (AlterableConfig _element : _object.configs) {
                _configsArray.add(AlterableConfigJsonConverter.write(_element, _version));
            }
