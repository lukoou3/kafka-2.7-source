...
public class OffsetForLeaderEpochRequestData implements ApiMessage {
    int replicaId;
    List<OffsetForLeaderTopic> topics;
    ...
    public OffsetForLeaderEpochRequestData(Struct _struct, short _version) {
        fromStruct(_struct, _version);
    }
    
    public OffsetForLeaderEpochRequestData() {
        this.replicaId = -2;
        this.topics = new ArrayList<OffsetForLeaderTopic>(0);
    }
    ...
    public OffsetForLeaderEpochRequestData duplicate() {
        ...
        ArrayList<OffsetForLeaderTopic> newTopics = new ArrayList<OffsetForLeaderTopic>(topics.size());
    ...
    public static class OffsetForLeaderTopic implements Message {
        ...
        public OffsetForLeaderTopic(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
    ...
    public static class OffsetForLeaderPartition implements Message {
        ...
        public OffsetForLeaderPartition(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
