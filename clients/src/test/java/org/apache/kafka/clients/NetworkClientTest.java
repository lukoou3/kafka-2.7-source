...
public class NetworkClientTest {
    ...
    public void testCloseConnectingNode() {
        ...
        client.ready(node1, time.milliseconds());
        ByteBuffer buffer = ApiVersionsResponse.DEFAULT_API_VERSIONS_RESPONSE.serialize(ApiKeys.API_VERSIONS, ApiKeys.API_VERSIONS.latestVersion(), 0);
        ...
        client.ready(node0, time.milliseconds());
        buffer = ApiVersionsResponse.DEFAULT_API_VERSIONS_RESPONSE.serialize(ApiKeys.API_VERSIONS, ApiKeys.API_VERSIONS.latestVersion(), 1);
